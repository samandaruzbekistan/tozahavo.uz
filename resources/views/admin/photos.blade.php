...
@section('section')
    ...
    <form id="forma" class="col-9" action="{{ route('new_photo') }}" style="display: none" method="post" enctype="multipart/form-data">
        @csrf
    ...
    <form id="forma2" class="col-9" action="{{ route('update_photo') }}" style="display: none" method="post" enctype="multipart/form-data">
        @csrf
        <div class="custom-file">
            <input type="file" name="photo" class="custom-file-input" id="customFile">
